...
% Implicit expansion is not covered in the course 
% and was introduced in MATLAB in R2016b. It enables 
% you to create a matrix using a row vector and column 
% vector with operators like +, -, |, and &. This 
% feature is used to create a logical matrix that 
% is true where there is a saddle point.
function s = sol2_saddle(M)   
